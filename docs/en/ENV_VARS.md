...
`python -m app.server_v2` reads `app/server_v2/.env`; process environment variables take precedence. The source of truth is [ServerV2Settings](https://github.com/ZHangZHengEric/Sage/blob/main/app/server_v2/core/settings.py).
