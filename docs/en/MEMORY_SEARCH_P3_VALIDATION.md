...
- this P3 step does not replace BM25 yet; it isolates it behind a backend boundary
- the goal is to make future session-history backend changes independent from `MemoryTool` and `SessionContext`
