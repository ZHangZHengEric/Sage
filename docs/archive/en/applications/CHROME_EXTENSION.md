...
- [Desktop](../../../en/applications/DESKTOP.md) — extension is usually used **with** a running desktop backend
- [Web](../../../en/applications/WEB.md) — full browser product and Docker/server workflows
