...
- **macOS**: `Sage-<version>-<arch>.tar.gz` 和 `.tar.gz.sig`
- **Windows**: `Sage-<version>-x86_64-setup.zip` 和 `.zip.sig`
     ...
     "artifacts": [
       {
         ...
         "url": "https://github.com/.../Sage-1.0.1-aarch64.tar.gz",
         "signature": "Content of .tar.gz.sig"
       },
       {
         "platform": "windows-x86_64",
         "url": "https://github.com/.../Sage-1.0.1-x86_64-setup.zip",
