...
`python -m app.server_v2` 读取 `app/server_v2/.env`，进程环境变量优先。默认值以 [ServerV2Settings](https://github.com/ZHangZHengEric/Sage/blob/main/app/server_v2/core/settings.py) 为准。
