...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--user-id", dest="user_id", default="cli-user")
    ...
    chat_parser.add_argument("--user-id", dest="user_id", default="cli-user")
    ...
    resume_parser.add_argument("--user-id", dest="user_id", default="cli-user")
...
async def _stream_request(request, json_output: bool, stats_output: bool) -> int:
    from common.services.cli_service import run_request_stream
...
def _build_request(args: argparse.Namespace, task: str):
    from common.services.cli_service import build_run_request, cli_runtime, run_request_stream
...
async def _run_command(args: argparse.Namespace) -> int:
    from common.services.cli_service import cli_runtime, validate_cli_runtime_requirements
...
def _doctor_command() -> int:
    from common.services.cli_service import collect_doctor_info
