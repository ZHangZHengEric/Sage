...
class RecentToolSelectionPolicy(_RecentSelectionState):
    ...
    description = "Keeps recently called Tools first, then fills the remaining count deterministically."
