...
_EN = {
    ...
    "error.model.queue_timeout": "The model request timed out waiting for capacity. Try again later.",
...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "zh": _overlay(
        **{
            ...
            "error.model.queue_timeout": "等待模型调用名额超时，请稍后重试。",
...
_COMPLETE_LOCALE_TEXT: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "error.model.queue_full": "A fila de solicitações ao modelo está cheia. Tente novamente mais tarde.",
        "error.model.queue_timeout": "O tempo de espera por capacidade do modelo esgotou. Tente novamente mais tarde.",
    ...
    "es": {
        ...
        "error.model.queue_full": "La cola de solicitudes al modelo está llena. Inténtalo más tarde.",
        "error.model.queue_timeout": "Se agotó el tiempo de espera para acceder al modelo. Inténtalo más tarde.",
    ...
    "fr": {
        ...
        "error.model.queue_full": "La file des requêtes au modèle est pleine. Réessayez plus tard.",
        "error.model.queue_timeout": "Le délai d’attente pour accéder au modèle a expiré. Réessayez plus tard.",
    ...
    "de": {
        ...
        "error.model.queue_full": "Die Warteschlange für Modellanfragen ist voll. Versuchen Sie es später erneut.",
        "error.model.queue_timeout": "Die Wartezeit auf freie Modellkapazität ist abgelaufen. Versuchen Sie es später erneut.",
    ...
    "ja": {
        ...
        "error.model.queue_full": "モデルへのリクエスト待ち行列がいっぱいです。しばらくしてから再試行してください。",
        "error.model.queue_timeout": "モデルの実行枠を待機中にタイムアウトしました。しばらくしてから再試行してください。",
    ...
    "ko": {
        ...
        "error.model.queue_full": "모델 요청 대기열이 가득 찼습니다. 잠시 후 다시 시도하세요.",
        "error.model.queue_timeout": "모델 실행 슬롯을 기다리는 중 시간이 초과되었습니다. 잠시 후 다시 시도하세요.",
    ...
    "ru": {
        ...
        "error.model.queue_full": "Очередь запросов к модели заполнена. Повторите попытку позже.",
        "error.model.queue_timeout": "Время ожидания свободного слота модели истекло. Повторите попытку позже.",
...
_ERROR_KEYS = {
    ...
    "model.queue_full": "error.model.queue_full",
    "model.queue_timeout": "error.model.queue_timeout",
