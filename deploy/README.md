...
`wiki`、`rustfs`、`jaeger`、`prometheus`、`cadvisor`、`loki`、`alloy` 使用共享 compose 文件 `deploy/docker-compose.shared.yml`，不再在 `dev`、`prod`、`test` 的 compose 文件中重复定义。
