...
from app.server_v2.conversations.a2a.card import RPC_PATH
from app.server_v2.conversations.a2a.context import REQUEST_ATTR, SageCallContextBuilder
from app.server_v2.conversations.a2a.handler import SageRequestHandler
...
async def a2a_key(
    ...
    if not token:
        raise SageV2Error(
            RuntimeErrorInfo(
                code="server.routers.a2a.unauthenticated",
