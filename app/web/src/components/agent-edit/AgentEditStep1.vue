      ...
      <Card class="transition-all hover:shadow-md rounded-xl bg-background/80 backdrop-blur-sm">
        ...
        <div class="px-5 pb-5 pt-4 space-y-4">
          <div v-for="(workflow, index) in store.workflowPairs" :key="index"
            class="border rounded-lg p-4 bg-background/70">
            <div class="flex items-center gap-2 mb-2">
              ...
              <Input :model-value="workflow.key" :placeholder="t('agent.workflowName')" class="flex-1 h-8"
            ...
            <div v-show="isWorkflowExpanded(index)" class="pl-4 border-l-2 border-muted/70 ml-1 space-y-2">
...
import { Loader, Trash2, Plus, ChevronDown, ChevronUp, ChevronRight, Workflow, Database } from 'lucide-vue-next'
