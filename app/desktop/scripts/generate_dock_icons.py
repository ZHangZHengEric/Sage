...
def create_icon_with_padding(input_path, output_path, size, padding_percent=0.15):
    """
    创建带有边距的图标
...
def generate_all_icons():
    ...
    for filename, size in sizes.items():
        ...
        create_icon_with_padding(source_icon, output_path, size, padding_percent=0.12)

    print("\nAll icons generated successfully!")
    print("Please rebuild the application to see the changes.")
