export default {
  ...
  'system.envVariablesTip': '每行一个变量，格式: KEY=VALUE',
  'system.configure': '配置',
  'system.envSaved': '环境变量已保存，重启后生效',
  ...
  'danmaku.timeDays': '最近{n}天',
  'danmaku.action.todo_write': '写入待办',
  'danmaku.action.load_skill': '加载技能',
  'danmaku.action.execute_shell_command': '执行终端命令',
  'danmaku.action.execute_python_code': '执行 Python 代码',
  'danmaku.action.file_write': '写入文件',
  'danmaku.countSuffix': '次',
