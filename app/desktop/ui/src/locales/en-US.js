export default {
  ...
  'system.envVariablesTip': 'One variable per line, format: KEY=VALUE',
  'system.configure': 'Configure',
  'system.envSaved': 'Environment variables saved, restart to take effect',
  ...
  'danmaku.action.todo_write': 'Todo write',
  'danmaku.action.load_skill': 'Load skill',
  'danmaku.action.execute_shell_command': 'Run shell command',
  'danmaku.action.execute_python_code': 'Run Python code',
  'danmaku.action.file_write': 'File write',
