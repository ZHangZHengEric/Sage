<template>
  <Collapsible
    v-model:open="isOpen"
    class="reasoning-content-message mb-1"
  >
    <CollapsibleTrigger class="w-full">
      <div class="flex items-center justify-start px-2 py-1.5 cursor-pointer select-none transition-all group">
        <div class="header-content flex items-center gap-1.5 flex-1">
          ...
          <span class="header-text text-sm font-medium text-foreground">{{ t('chat.reasoningTitle') }}</span>
    ...
    <CollapsibleContent class="reasoning-content text-sm leading-6 text-muted-foreground pl-7">
