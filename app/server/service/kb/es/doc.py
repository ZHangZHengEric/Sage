...
async def get_documents_by_ids(index_name: str, doc_ids: List[str]) -> Dict[str, DocDocument]:
...
async def doc_document_search(index_name: str, question: str, emb: List[float], size: int) -> List[DocDocument]:
